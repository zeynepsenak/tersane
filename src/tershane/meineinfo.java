...
public class meineinfo extends javax.swing.JFrame {
    ...
    public meineinfo(String id) {
        ...
        jLabel9.setText(kk);
        jLabel8.setText(info[0]);
        jLabel7.setText(info[1]);
        jLabel6.setText(info[2]);
        jTextField1.setText(info[3]);
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int i = Integer.parseInt(kk);
        String ant = func.updpass(i, pass);
        jLabel10.setText(ant);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(meineinfo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
